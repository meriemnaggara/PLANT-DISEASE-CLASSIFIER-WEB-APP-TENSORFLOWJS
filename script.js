...
let pconf = document.querySelector('.box-result p')
        ...
        async function fetchData(){
            let response = await fetch('C:\wamp\www\APPLICATION DE CLASSIFICATION DES MALADIES DES PLANTES\class_indices.json');
        ...
        async function initialize() {
            ...
            model = await tf.loadLayersModel('C:\wamp\www\APPLICATION DE CLASSIFICATION DES MALADIES DES PLANTES\tensorflowjs-model\model.json');
